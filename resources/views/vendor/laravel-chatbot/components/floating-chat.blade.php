<div id="lc-floating-chat-root" style="all: initial;">
    <style>
        ...
        .lc-fc-button {
            ...
            background: linear-gradient(135deg, #FD5528 0%, #FD5528 100%);
        ...
        .lc-fc-header {
            padding: 10px 12px; background: linear-gradient(135deg, #FD5528 0%, #FD5528 100%); color: #fff;
            font-weight: 600; font-size: 14px;
        }
        .lc-fc-body { background: #f9fafb; height: 250px; overflow: auto; padding: 10px; }
        ...
        .lc-fc-send { margin-top: 6px; width: 100%; padding: 9px 12px; border: none; border-radius: 8px; background: #FD5528; color: #fff; cursor: pointer; }
        ...
        .lc-fc-buttons a { text-decoration: none; text-align: center; padding: 10px 12px; border-radius: 8px; font-weight: 500; border: 1px solid #FD5528; color: #667eea; background: #fff; }
        .lc-fc-buttons a.btn-primary { background: #FD5528; color: #fff; border-color: #FD5528; }
    </style>

...
<div class="mx-auto max-w-4xl space-y-6">
    <div>
        <h2 class="text-3xl font-bold text-slate-900 dark:text-white">Add project</h2>
        <p class="mt-1 text-sm text-slate-500 dark:text-slate-400">Create a new portfolio item.</p>
    </div>
        ...
        <form action="{{ route('projects.store') }}" method="POST" enctype="multipart/form-data" class="grid gap-5">
            ...
            <div class="grid gap-5 md:grid-cols-2">
                ...
                <div>
                    ...
                    <input type="text" name="client_name" value="{{ old('client_name') }}" class="w-full rounded-2xl border border-slate-200 bg-white px-4 py-3 text-slate-900 outline-none transition focus:border-[#FD5528] focus:ring-4 focus:ring-[#FD5528]/10 dark:border-white/10 dark:bg-slate-950/40 dark:text-white">
                </div>
            </div>
            ...
            <div class="grid gap-5 md:grid-cols-2">
                <div>
                    ...
                    <input type="text" name="category" value="{{ old('category') }}" placeholder="Web, SaaS, CRM..." class="w-full rounded-2xl border border-slate-200 bg-white px-4 py-3 text-slate-900 outline-none transition focus:border-[#FD5528] focus:ring-4 focus:ring-[#FD5528]/10 dark:border-white/10 dark:bg-slate-950/40 dark:text-white">
                </div>
                <div>
                    <label class="mb-2 block text-sm font-medium text-slate-700 dark:text-slate-200">Status</label>
                    <input type="text" name="status" value="{{ old('status', 'LIVE') }}" class="w-full rounded-2xl border border-slate-200 bg-white px-4 py-3 text-slate-900 outline-none transition focus:border-[#FD5528] focus:ring-4 focus:ring-[#FD5528]/10 dark:border-white/10 dark:bg-slate-950/40 dark:text-white">
                </div>
            </div>
            ...
            <div>
                ...
                <div id="technologyList" class="mt-3 space-y-3">
                    <div class="flex items-center gap-3">
                        <input type="text" name="technologies[]" value="{{ $technologyValues[0] ?? '' }}" placeholder="Laravel" class="technology-input w-full rounded-2xl border border-slate-200 bg-white px-4 py-3 text-slate-900 outline-none transition focus:border-[#FD5528] focus:ring-4 focus:ring-[#FD5528]/10 dark:border-white/10 dark:bg-slate-950/40 dark:text-white">
            ...
            <div class="grid gap-5 md:grid-cols-2">
                <div>
                    ...
                    <input type="url" name="live_url" value="{{ old('live_url') }}" class="w-full rounded-2xl border border-slate-200 bg-white px-4 py-3 text-slate-900 outline-none transition focus:border-[#FD5528] focus:ring-4 focus:ring-[#FD5528]/10 dark:border-white/10 dark:bg-slate-950/40 dark:text-white">
                </div>
            </div>
            ...
            <div class="grid gap-5 md:grid-cols-2">
                <div>
                    ...
                    <input type="date" name="completed_at" value="{{ old('completed_at') }}" class="w-full rounded-2xl border border-slate-200 bg-white px-4 py-3 text-slate-900 outline-none transition focus:border-[#FD5528] focus:ring-4 focus:ring-[#FD5528]/10 dark:border-white/10 dark:bg-slate-950/40 dark:text-white">
                </div>
            ...
            <div>
                ...
                <textarea name="description" rows="6" class="w-full rounded-2xl border border-slate-200 bg-white px-4 py-3 text-slate-900 outline-none transition focus:border-[#FD5528] focus:ring-4 focus:ring-[#FD5528]/10 dark:border-white/10 dark:bg-slate-950/40 dark:text-white">{{ old('description') }}</textarea>
            </div>

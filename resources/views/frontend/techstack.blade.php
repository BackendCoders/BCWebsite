...
<!-- HERO -->
<section class="bg-gradient-to-r from-[#FC5124] to-orange-600 text-white py-20 text-center">
  ...
  <p class="text-lg text-white/90 max-w-2xl mx-auto" data-aos="fade-up" data-aos-delay="200">
    We use modern technologies to build scalable, high-performance solutions.
  </p>
</section>

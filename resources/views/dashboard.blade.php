...
<x-app-layout>
<div class="space-y-8">
    <section class="relative overflow-hidden rounded-[2.25rem] border border-slate-200/70 bg-white/90 p-6 shadow-[0_24px_80px_rgba(15,23,42,0.08)] backdrop-blur-xl dark:border-white/10 dark:bg-white/5 dark:shadow-black/20 sm:p-8">
        <div class="absolute inset-0 bg-[radial-gradient(circle_at_top_right,_rgba(253,85,40,0.14),_transparent_35%),radial-gradient(circle_at_bottom_left,_rgba(15,23,42,0.05),_transparent_30%)]"></div>
        <div class="relative grid gap-8 xl:grid-cols-12 xl:items-start">
            <div class="xl:col-span-8">
                ...
                <h1 class="mt-5 max-w-3xl text-3xl font-bold tracking-tight text-slate-900 dark:text-white sm:text-4xl lg:text-5xl">
                    A professional control center for pages, blogs, and business content.
                </h1>
                <p class="mt-4 max-w-2xl text-sm leading-7 text-slate-500 dark:text-slate-300 sm:text-base">
                    Keep content, categories, careers, projects, services, and applications organized from one streamlined workspace with the same orange, white, and gray brand system.
                </p>
                ...
                <div class="mt-6 flex flex-wrap gap-3">
                    ...
                    <a href="{{ route('categories.index') }}" class="inline-flex items-center justify-center rounded-2xl border border-slate-200 bg-white px-5 py-3 text-sm font-semibold text-slate-700 transition hover:border-[#FD5528] hover:text-[#FD5528] dark:border-white/10 dark:bg-slate-950/40 dark:text-slate-200">
                        Manage Categories
                    </a>
                    <a href="{{ route('pages.index') }}" class="inline-flex items-center justify-center rounded-2xl border border-slate-200 bg-white px-5 py-3 text-sm font-semibold text-slate-700 transition hover:border-[#FD5528] hover:text-[#FD5528] dark:border-white/10 dark:bg-slate-950/40 dark:text-slate-200">
                        View Pages
                    </a>
                </div>

                <div class="mt-8 grid gap-4 sm:grid-cols-2 xl:grid-cols-3">
                    <div class="rounded-[1.75rem] border border-slate-200/70 bg-white p-5 shadow-sm dark:border-white/10 dark:bg-slate-950/40">
                        <p class="text-xs uppercase tracking-[0.35em] text-slate-400">Categories</p>
                        <div class="mt-3 flex items-end justify-between gap-4">
                            <div>
                                <p class="text-3xl font-bold text-slate-900 dark:text-white">{{ $categoryCount }}</p>
                                <p class="mt-1 text-sm text-slate-500 dark:text-slate-400">Ready to assign to blog posts</p>
                            </div>
                    ...
                    <div class="rounded-[1.75rem] border border-slate-200/70 bg-white p-5 shadow-sm dark:border-white/10 dark:bg-slate-950/40">
                        <p class="text-xs uppercase tracking-[0.35em] text-slate-400">Blogs</p>
                        <div class="mt-3 flex items-end justify-between gap-4">
                            <div>
                                <p class="text-3xl font-bold text-slate-900 dark:text-white">{{ $blogCount }}</p>
                                <p class="mt-1 text-sm text-slate-500 dark:text-slate-400">Posts in the content library</p>
                            </div>
                    ...
                    <div class="rounded-[1.75rem] border border-slate-200/70 bg-white p-5 shadow-sm dark:border-white/10 dark:bg-slate-950/40">
                        ...
                        <div class="mt-3 flex items-end justify-between gap-4">
                            <div>
                                <p class="text-3xl font-bold text-slate-900 dark:text-white">{{ $serviceCount }}</p>
                                <p class="mt-1 text-sm text-slate-500 dark:text-slate-400">Service cards available for display</p>
                            </div>
            ...
            <div class="xl:col-span-4">
                <div class="rounded-[2rem] border border-slate-200/70 bg-slate-50 p-5 dark:border-white/10 dark:bg-white/5">
                    <div class="flex items-center justify-between">
                        <div>
                            <p class="text-sm font-medium text-slate-500 dark:text-slate-400">Workspace status</p>
                            <h2 class="mt-1 text-xl font-semibold text-slate-900 dark:text-white">Quick stats</h2>
                        </div>
        ...
        <div class="xl:col-span-12">
            <div class="rounded-[2rem] border border-slate-200/70 bg-white/80 p-6 shadow-xl shadow-slate-200/40 backdrop-blur-xl dark:border-white/10 dark:bg-white/5 dark:shadow-black/20">
                <div class="flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between">
                    <div>
                        <p class="text-sm text-slate-500 dark:text-slate-400">Main menu items</p>
                        <h3 class="mt-1 text-2xl font-bold text-slate-900 dark:text-white">Navigate the admin workspace faster</h3>
                    </div>
                ...
                <div class="mt-6 grid gap-4 sm:grid-cols-2 xl:grid-cols-4">
                    <a href="{{ route('pages.index') }}" class="group rounded-[1.75rem] border border-slate-200/70 bg-slate-50 p-5 transition hover:-translate-y-0.5 hover:border-[#FD5528]/30 hover:shadow-lg dark:border-white/10 dark:bg-slate-950/40">
                        <p class="text-xs uppercase tracking-[0.32em] text-slate-400">Content</p>
                        <h4 class="mt-2 text-lg font-semibold text-slate-900 transition group-hover:text-[#FD5528] dark:text-white">Pages</h4>
                        <p class="mt-2 text-sm text-slate-500 dark:text-slate-400">Create and edit landing pages, service pages, and sections.</p>
                    </a>

                    <a href="{{ route('categories.index') }}" class="group rounded-[1.75rem] border border-slate-200/70 bg-slate-50 p-5 transition hover:-translate-y-0.5 hover:border-[#FD5528]/30 hover:shadow-lg dark:border-white/10 dark:bg-slate-950/40">
                        <p class="text-xs uppercase tracking-[0.32em] text-slate-400">Library</p>
                        <h4 class="mt-2 text-lg font-semibold text-slate-900 transition group-hover:text-[#FD5528] dark:text-white">Categories</h4>
                        <p class="mt-2 text-sm text-slate-500 dark:text-slate-400">Organize blog topics before publishing new content.</p>
                    </a>

                    <a href="{{ route('blogs.index') }}" class="group rounded-[1.75rem] border border-slate-200/70 bg-slate-50 p-5 transition hover:-translate-y-0.5 hover:border-[#FD5528]/30 hover:shadow-lg dark:border-white/10 dark:bg-slate-950/40">
                        <p class="text-xs uppercase tracking-[0.32em] text-slate-400">Publishing</p>
                        <h4 class="mt-2 text-lg font-semibold text-slate-900 transition group-hover:text-[#FD5528] dark:text-white">Blogs</h4>
                        <p class="mt-2 text-sm text-slate-500 dark:text-slate-400">Manage drafts, published posts, and post categories.</p>
                    </a>

                    <a href="{{ route('services.index') }}" class="group rounded-[1.75rem] border border-slate-200/70 bg-slate-50 p-5 transition hover:-translate-y-0.5 hover:border-[#FD5528]/30 hover:shadow-lg dark:border-white/10 dark:bg-slate-950/40">
                        <p class="text-xs uppercase tracking-[0.32em] text-slate-400">Offerings</p>
                        <h4 class="mt-2 text-lg font-semibold text-slate-900 transition group-hover:text-[#FD5528] dark:text-white">Services</h4>
                        <p class="mt-2 text-sm text-slate-500 dark:text-slate-400">Keep service cards updated across the site.</p>
                    </a>
                </div>
            </div>
        </div>
            ...
            <div class="rounded-[2rem] border border-slate-200/70 bg-white/80 p-6 shadow-xl shadow-slate-200/40 backdrop-blur-xl dark:border-white/10 dark:bg-white/5 dark:shadow-black/20">
                ...
                <div class="mt-6 space-y-3">
                    @forelse($recentCategories as $category)
                        <div class="flex items-start justify-between gap-4 rounded-2xl border border-slate-200/70 bg-slate-50 px-4 py-4 dark:border-white/10 dark:bg-slate-950/40">
                            <div>
    ...
    <section class="grid gap-6 xl:grid-cols-12">
        <div class="xl:col-span-12">
            <div class="rounded-[2rem] border border-[#FD5528]/15 bg-gradient-to-r from-[#FD5528]/10 via-white to-slate-50 p-6 shadow-xl shadow-slate-200/40 backdrop-blur-xl dark:from-[#FD5528]/10 dark:via-white/5 dark:to-white/5 dark:shadow-black/20">
                <div class="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
                    <div>
                        <p class="text-sm font-medium text-[#FD5528]">Content flow</p>
                        <h3 class="mt-1 text-2xl font-bold text-slate-900 dark:text-white">Everything you need to keep the site moving</h3>
                    ...
                    <div class="grid gap-3 sm:grid-cols-3">
                        ...
                        <a href="{{ route('pages.create') }}" class="inline-flex items-center justify-center rounded-2xl border border-slate-200 bg-white px-5 py-3 text-sm font-semibold text-slate-700 transition hover:border-[#FD5528] hover:text-[#FD5528] dark:border-white/10 dark:bg-slate-950/40 dark:text-slate-200">
                            Create Page
                        </a>
                        <a href="{{ route('services.index') }}" class="inline-flex items-center justify-center rounded-2xl border border-slate-200 bg-white px-5 py-3 text-sm font-semibold text-slate-700 transition hover:border-[#FD5528] hover:text-[#FD5528] dark:border-white/10 dark:bg-slate-950/40 dark:text-slate-200">
                            Open Services
                        </a>
                    </div>
                </div>
